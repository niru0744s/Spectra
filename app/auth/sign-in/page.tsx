    ...
    <main className="flex flex-1 items-center justify-center p-4">
      <div className="w-full max-w-md rounded-xl border border-[#e5e2e1] bg-white p-8 shadow-[0_4px_20px_rgba(0,0,0,0.04)]">
        ...
        <div className="mb-8 flex rounded-lg bg-[#f6f3f2] p-1 text-sm font-medium">
          <Link href="/auth/sign-in" className="flex-1 rounded-md bg-white py-2 text-center shadow-sm">
            Sign In
          </Link>
          <Link href="/auth/sign-up" className="flex-1 rounded-md py-2 text-center text-zinc-500">
            Sign Up
          </Link>
        </div>
        ...
        <form className="space-y-4">
          ...
          <div className="flex justify-end">
            <a href="#" className="text-xs font-medium text-[#1e2a44] hover:underline">
              Forgot password?
            </a>
          </div>
